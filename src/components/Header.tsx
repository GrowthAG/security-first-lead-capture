...
const Header = () => {
  ...
  return (
    <header className="bg-white sticky top-0 z-40 shadow-sm">
      <div className="container mx-auto py-1 px-2 md:py-2 md:px-4 flex justify-between items-center">
        ...
        <div className="md:hidden">
          <Button 
            onClick={scrollToForm}
            className="bg-security-red hover:bg-security-red/90 text-white text-xs py-1 px-2"
            size="sm"
          >
            <PhoneCall size={14} />
          </Button>
