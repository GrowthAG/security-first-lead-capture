      ...
      <div className="container mx-auto px-4 w-full">
        <div className="grid md:grid-cols-2 gap-4 md:gap-12 items-center">
          <div className={`text-white ${isMobile ? 'text-center' : ''}`}>
            <h1 className="font-montserrat text-xl md:text-5xl font-bold leading-tight mb-2 md:mb-0">
              Proteja sua Empresa com o SOC 24x7 Mais Ágil e Eficiente do Brasil.
            </h1>
            <p className="mt-2 md:mt-6 text-sm md:text-xl font-light opacity-90 leading-relaxed mb-3">
          ...
          <div className="hidden md:flex justify-center">
            <div className="relative w-full max-w-lg">
              <img 
                ...
                alt="SOC Cybersecurity - Security Operations Center monitoring screens" 
