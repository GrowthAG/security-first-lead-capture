        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`text-white ${isMobile ? 'text-center' : ''}`}>
            ...
            <p className="mt-4 md:mt-6 text-lg md:text-xl font-light opacity-90">
              ...
              <span className="text-security-red font-bold ml-2">!</span>
            </p>
          ...
          <div className="hidden md:flex justify-center">
            <div className="bg-white/10 p-8 rounded-lg border border-white/20 backdrop-blur-sm animate-float">
              <img src="/lovable-uploads/d572cf3c-4066-4575-851c-76a0bc52c7a2.png" alt="SOC Cybersecurity Dashboard" className="rounded-lg shadow-lg w-full max-w-md" />
            </div>
          </div>
        </div>
      </div>
