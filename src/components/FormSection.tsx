      ...
      <section id="formulario" className="py-8 md:py-20 gradient-bg min-h-screen md:min-h-0 flex items-center">
        <div className="container mx-auto px-4 w-full">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-montserrat font-bold text-base md:text-4xl text-white mb-4 md:mb-6 leading-relaxed px-2">
            ...
            <h3 className="text-white text-sm md:text-2xl font-semibold mb-3 md:mb-4 px-2">
              Solicite uma Avaliação Gratuita
            </h3>
            <p className="text-white/90 text-xs md:text-lg mb-8 md:mb-8 px-4 leading-relaxed">
