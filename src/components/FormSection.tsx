...
const FormSection = () => {
  ...
  return (
    <>
      <section id="formulario" className="py-12 md:py-20 gradient-bg min-h-screen md:min-h-0 flex items-center">
        <div className="container mx-auto px-4 w-full">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-montserrat font-bold text-lg md:text-4xl text-white mb-4 md:mb-6 leading-relaxed px-2">
            ...
            <p className="text-white/90 text-sm md:text-lg mb-4 md:mb-8 px-3 leading-relaxed">
              Entre em contato conosco e descubra como podemos fortalecer a segurança da sua empresa.
            </p>
            <h3 className="text-white text-base md:text-2xl font-semibold mb-3 md:mb-4 px-2">
              Solicite uma Avaliação Gratuita
            </h3>
            <p className="text-white/90 text-xs md:text-lg mb-6 md:mb-8 px-4 leading-relaxed">
