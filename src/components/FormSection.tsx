...
const FormSection = () => {
  ...
  return (
    <>
      <section id="formulario" className="py-12 md:py-20 gradient-bg">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-montserrat font-bold text-lg md:text-4xl text-white mb-4 md:mb-6 leading-tight">
            ...
            <h3 className="text-white text-base md:text-2xl font-semibold mb-3 md:mb-4">
              Solicite uma Avaliação Gratuita
            </h3>
            <p className="text-white/90 text-xs md:text-lg mb-6 md:mb-8 px-2">
            ...
            <div className="flex justify-center pb-8 md:pb-0">
              <Button 
                ...
                className="bg-security-red hover:bg-security-red/90 text-white text-sm md:text-lg py-3 md:py-6 px-4 md:px-8 w-full max-w-xs md:w-auto shadow-lg"
                size="lg"
              >
