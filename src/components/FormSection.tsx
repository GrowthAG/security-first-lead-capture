      ...
      <section id="formulario" className="py-8 md:py-20 gradient-bg min-h-screen md:min-h-0 flex items-center">
        <div className="container mx-auto px-4 w-full">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-montserrat font-bold text-xl md:text-4xl text-white mb-3 md:mb-6 leading-relaxed px-2">
            ...
            <h3 className="text-white text-lg md:text-2xl font-semibold mb-2 md:mb-4 px-2">
              Solicite uma Avaliação Gratuita
            </h3>
            <p className="text-white/90 text-sm md:text-lg mb-4 md:mb-8 px-4 leading-relaxed">
            ...
            <div className="flex justify-center px-4">
              <Button 
                ...
                className="bg-security-red hover:bg-security-red/90 text-white text-base md:text-lg py-4 md:py-6 px-8 md:px-8 w-full max-w-xs md:w-auto shadow-lg rounded-lg font-medium"
                size="lg"
              >
